    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
      <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <dl className="mt-8 space-y-6">
            {POINTS.map(({ icon: Icon, title, description }) => (
              <div key={title} className="flex gap-4">
                ...
                <div>
                  <dt className="font-heading text-base font-bold text-navy">
                    {title}
                  </dt>
        ...
        <div className="relative">
          ...
          <div className="rounded-[2rem] border border-mist bg-white p-8 shadow-xl shadow-navy/5">
            ...
            <div className="mt-6 space-y-3">
              {[
                ...
                <div
                  key={item}
                  className="flex items-center gap-3 rounded-xl bg-offwhite px-4 py-3 text-sm font-medium text-navy"
                >
