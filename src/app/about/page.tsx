      ...
      <section className="bg-navy">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-balance leading-relaxed text-white/70">
            ...
            platform built to organize, preserve, verify, and present
            trusted information about leaders, professionals, government
            officials, and public figures. We exist so that a lifetime of
            public service and professional achievement is never lost to
            time.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="rounded-2xl border border-mist p-8">
            ...
            <p className="mt-3 leading-relaxed text-slate">
              To give every leader, professional, and public figure a
              verified, secure, and permanent digital identity that
              accurately reflects their career, achievements, and
              contributions &mdash; accessible to the people and
              institutions that rely on trusted information.
            </p>
          </div>
          <div className="rounded-2xl border border-mist p-8">
            ...
            <p className="mt-3 leading-relaxed text-slate">
              A world where leadership history is preserved with the same
              rigor as official government records &mdash; verifiable,
              organized, and accessible for generations, regardless of
              changes in office, institution, or technology.
            </p>
          </div>
        </div>
      </section>
